...
public partial class Admin_Default : System.Web.UI.Page
{
    ...
    protected void btnsave_Click(object sender, EventArgs e)
    {
        if (flag == 1)
        {
            string upQry = "update tbl_category set category_name= '" + txtcategory.Text + "' where category_id= '" + idNo + "'";
        ...
        {
            String insquery = "insert into tbl_category (category_name) values('" + txtcategory.Text + "')";
    ...
    {
        String setQuery = "select * from tbl_category";
        //SqlDataAdapter adap = new SqlDataAdapter(setQuery, con);
        //DataTable dt = new DataTable();
        //adap.Fill(dt);
        //grdcategory.DataSource = dt;
        //grdcategory.DataBind();
        obj.FillGridView(setQuery, grdcategory);
    ...
    protected void grdcategory_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "ed")
        {
            ...
            string selQry = "select * from tbl_category where category_id = '" + idNo + "'";
