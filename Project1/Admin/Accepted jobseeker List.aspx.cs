...
public partial class Admin_Default : System.Web.UI.Page
{
    ...
    {
        String setQuery = "select * from tbl_jsregistration where js_status='1'";
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "dwnl")
        {
            ...
            Response.AppendHeader("Content-disposition", "attachment;js_cv=" + name + "");
            Response.TransmitFile(Server.MapPath("../Guest/proof/cv/" + name));
            Response.End();
