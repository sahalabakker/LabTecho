...
public partial class Admin_Default : System.Web.UI.Page
{
    ...
    protected void GridView2_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "del")
        {
            ...
            string delQry = "delete from tbl_jobseekertype where jobseeker_id = '" + idNo + "'";
        ...
        if (e.CommandName == "ed")
        {
            ...
            string selQry = "select * from tbl_jobseekertype where jobseeker_id = '" + idNo + "'";
            //SqlDataAdapter adap = new SqlDataAdapter(selQry, con);
            //DataTable dt = new DataTable();
            //adap.Fill(dt);
            DataTable dt = obj.GetDataTable(selQry);
            txtjobsee.Text = dt.Rows[0]["jobtype"].ToString();
            flag = 1;
        }
    }
    protected void btnsave_Click(object sender, EventArgs e)
    {
        if (flag == 1)
        {
            string upQry = "update tbl_jobseekertype set jobtype= '" + txtjobsee.Text + "' where jobseeker_id= '" + idNo + "'";
        ...
        {
            String insquery = "insert into tbl_jobseekertype (jobtype) values('" + txtjobsee.Text + "')";
    ...
    {
        String setQuery = "select * from tbl_jobseekertype";
